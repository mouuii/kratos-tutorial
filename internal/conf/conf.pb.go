...
type Data struct {
	...
	Cit      *Data_MyConfig `protobuf:"bytes,3,opt,name=cit,proto3" json:"cit,omitempty"`
}
...
func (x *Data) GetCit() *Data_MyConfig {
	if x != nil {
		return x.Cit
	}
	return nil
...
type Data_MyConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Cit string `protobuf:"bytes,1,opt,name=cit,proto3" json:"cit,omitempty"`
}

func (x *Data_MyConfig) Reset() {
	*x = Data_MyConfig{}
	if protoimpl.UnsafeEnabled {
...
func (x *Data_MyConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_MyConfig) ProtoMessage() {}

func (x *Data_MyConfig) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_MyConfig.ProtoReflect.Descriptor instead.
func (*Data_MyConfig) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{2, 2}
}

func (x *Data_MyConfig) GetCit() string {
	if x != nil {
		return x.Cit
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x64, 0x69, 0x73, 0x12, 0x2b, 0x0a, 0x03, 0x63, 0x69, 0x74, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x44, 0x61, 0x74, 0x61, 0x2e, 0x4d, 0x79, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x03, 0x63,
	0x69, 0x74, 0x1a, 0x3a, 0x0a, 0x08, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x12, 0x16,
	...
	0x65, 0x6f, 0x75, 0x74, 0x1a, 0x1c, 0x0a, 0x08, 0x4d, 0x79, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x12, 0x10, 0x0a, 0x03, 0x63, 0x69, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x63,
	0x69, 0x74, 0x42, 0x21, 0x5a, 0x1f, 0x64, 0x65, 0x76, 0x6f, 0x70, 0x73, 0x2d, 0x61, 0x67, 0x65,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data_MyConfig)(nil),       // 7: kratos.api.Data.MyConfig
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	7,  // 6: kratos.api.Data.cit:type_name -> kratos.api.Data.MyConfig
